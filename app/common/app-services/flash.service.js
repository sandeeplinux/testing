...
angular.module('app').factory('flashService', ['$rootScope','$cookieStore','toaster', function ($rootScope, $cookieStore,toaster) {
  ...
  /*
    @types: types is nothing but bootstrap alert classes
  */
    
  function displayMessages(message, type, keepAfterLocationChange){
  ...
  service.displayMessages = displayMessages;
  return service;
